...
export default function Topbar() {
    ...
    return (
        <header className="h-16 border-b border-border bg-white/80 backdrop-blur-md flex items-center justify-between px-8 sticky top-0 z-40">

            {/* 🔍 SEARCH */}
            <div className="relative w-80" ref={searchRef}>
                <div className="flex items-center gap-2 bg-gray-50 border border-border rounded-lg px-3 h-10">
            ...
            <div className="flex items-center gap-6">
                ...
                >
                    ...
                    {profileOpen && (
                        <div className="absolute right-0 top-14 w-56 bg-white shadow-xl rounded-xl border border-border p-2 space-y-1 z-50">
